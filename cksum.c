...
#define DO1(ptr,i)	{adler += (ptr)[i]; sum2 += adler;}
#define DO2(ptr,i)	DO1(ptr,i); DO1(ptr,i+1);
#define DO4(ptr,i)	DO2(ptr,i); DO2(ptr,i+2);
#define DO8(ptr,i)	DO4(ptr,i); DO4(ptr,i+4);
#define DO16(ptr)	DO8(ptr,0); DO8(ptr,8);
...
out:	return (adler | ((u_int)sum2 << 16));
}
...
inline static int in_cksum_add(void *ptr, size_t n, int cksum)
{
	...
	return (n & 1) ? (cksum += htons((u_short)
		(*(u_char *)p << 8))) : cksum;
}
